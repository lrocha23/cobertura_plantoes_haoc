...
# Caminho do arquivo temporário (onde o Streamlit Cloud permite escrita)
csv_temp = "/tmp/plantoes.csv"

# Se o arquivo temporário não existir, copie o original do repositório
...
if st.button("Salvar alterações"):
    df_original = pd.read_csv(csv_temp)
